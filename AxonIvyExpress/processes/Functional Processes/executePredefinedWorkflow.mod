...
Bk4 @Alternative f41 '' #zField
Bk4 @PushWFArc f42 '' #zField
...
' #txt
Bk4 f42 304 128 664 128 #arcP
Bk4 f42 0 0.5583333333333333 0 -8 #arcLabel
Bk4 f26 expr in #txt
Bk4 f26 outCond 'in.workflowType == ch.ivy.gawfs.enums.ProcessType.AD_HOC' #txt
...
' #txt
Bk4 f26 680 144 680 186 #arcP
Bk4 f26 0 0.4523809523809524 25 0 #arcLabel
...
' #txt
Bk4 f44 696 128 936 506 #arcP
Bk4 f44 1 936 128 #addKink
Bk4 f44 0 0.5125 1 -14 #arcLabel
...
TaskA.PRI=2
TaskA.ROL=CREATOR
TaskA.SCRIPT=task.setCategoryPath(ch.ivy.addon.portalkit.util.PredefinedWorkflowUtils.generateExpressTaskCategoryPath(in1.workflowType, in1.workflowName, in1.currentTask.subject));
TaskA.SKIP_TASK_LIST=false
TaskA.TYPE=0' #txt
Bk7 f7 template "" #txt
...
' #txt
Bk8 f11 304 349 227 398 #arcP
Bk8 f11 1 227 349 #addKink
...
Bk4 f23 out f42 tail #connect
Bk4 f42 head f41 in #connect
Bk4 f41 out f26 tail #connect
Bk4 f26 head f25 mainIn #connect
Bk4 f41 out f44 tail #connect
