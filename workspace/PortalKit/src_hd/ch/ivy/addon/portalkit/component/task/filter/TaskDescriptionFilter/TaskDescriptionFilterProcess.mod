[Ivy]
15DC1739633E4DE0 9.3.1 #module
>Proto >Proto Collection #zClass
Ts0 TaskDescriptionFilterProcess Big #zClass
Ts0 RD #cInfo
Ts0 #process
...
>Proto Ts0 Ts0 TaskDescriptionFilterProcess #zField
...
>Proto Ts0 .type ch.ivy.addon.portalkit.component.task.filter.TaskDescriptionFilter.TaskDescriptionFilterData #txt
