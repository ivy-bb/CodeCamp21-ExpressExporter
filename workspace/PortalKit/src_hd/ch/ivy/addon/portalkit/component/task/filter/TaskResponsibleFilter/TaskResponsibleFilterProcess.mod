...
' #txt
Ts0 f6 outParameterDecl '<java.util.List<ch.ivy.addon.portalkit.dto.SecurityMemberDTO> responsibles> result;' #txt
Ts0 f6 outActionCode 'import ch.ivy.addon.portalkit.constant.PortalConstants;
import ch.ivy.addon.portalkit.util.SecurityMemberUtils;

result.responsibles = SecurityMemberUtils.findSecurityMembers(in.queryAutoComplete, 0, PortalConstants.MAX_USERS_IN_AUTOCOMPLETE);' #txt
