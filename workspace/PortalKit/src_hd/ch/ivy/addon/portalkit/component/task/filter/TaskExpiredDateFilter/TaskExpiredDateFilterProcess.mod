...
>Proto Ts0 Ts0 TaskExpiredDateFilterProcess #zField
...
>Proto Ts0 .type ch.ivy.addon.portalkit.component.task.filter.TaskExpiredDateFilter.TaskExpiredDateFilterData #txt
