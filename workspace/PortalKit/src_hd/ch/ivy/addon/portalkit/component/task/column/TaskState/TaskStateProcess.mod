[Ivy]
15AE9BB535636FEB 9.3.1 #module
>Proto >Proto Collection #zClass
Ts0 TaskStateProcess Big #zClass
Ts0 RD #cInfo
Ts0 #process
...
>Proto Ts0 Ts0 TaskStateProcess #zField
...
>Proto Ts0 .type ch.ivy.addon.portalkit.component.task.column.TaskState.TaskStateData #txt
