[Ivy]
15AE9CC2C41A3F66 9.3.1 #module
>Proto >Proto Collection #zClass
Ts0 TaskResponsibleProcess Big #zClass
Ts0 RD #cInfo
Ts0 #process
...
>Proto Ts0 Ts0 TaskResponsibleProcess #zField
...
>Proto Ts0 .type ch.ivy.addon.portalkit.component.task.column.TaskResponsible.TaskResponsibleData #txt
