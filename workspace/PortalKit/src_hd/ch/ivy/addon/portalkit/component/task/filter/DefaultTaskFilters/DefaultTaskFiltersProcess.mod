[Ivy]
15DC4C9A24129587 9.3.1 #module
>Proto >Proto Collection #zClass
Ts0 DefaultTaskFiltersProcess Big #zClass
Ts0 RD #cInfo
Ts0 #process
...
>Proto Ts0 Ts0 DefaultTaskFiltersProcess #zField
...
>Proto Ts0 .type ch.ivy.addon.portalkit.component.task.filter.DefaultTaskFilters.DefaultTaskFiltersData #txt
