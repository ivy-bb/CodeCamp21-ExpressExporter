package ch.ivy.addon.portalkit.singleapp.general.Login;

/**
 */
@SuppressWarnings("all")
@javax.annotation.processing.Generated(comments="This is the java file of the ivy data class LoginData", value={"ch.ivyteam.ivy.scripting.streamInOut.IvyScriptJavaClassBuilder"})
public class LoginData extends ch.ivyteam.ivy.scripting.objects.CompositeObject
{
  /** SerialVersionUID */
  private static final long serialVersionUID = -2767648684997761832L;
  ...
  private java.lang.Boolean loginOk;

  /**
   * Gets the field loginOk.
   * @return the value of the field loginOk; may be null.
   */
  public java.lang.Boolean getLoginOk()
  {
    return loginOk;
  }

  /**
   * Sets the field loginOk.
   * @param _loginOk the new value of the field loginOk.
   */
  public void setLoginOk(java.lang.Boolean _loginOk)
  {
    loginOk = _loginOk;
  }
