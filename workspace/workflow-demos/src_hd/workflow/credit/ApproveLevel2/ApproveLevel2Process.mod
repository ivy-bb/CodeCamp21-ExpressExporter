...
>Proto As0 As0 ApproveLevel2Process #zField
...
out.dossier.decision.level2Approved=false;
' #txt
...
>Proto As0 .type workflow.credit.ApproveLevel2.ApproveLevel2Data #txt
