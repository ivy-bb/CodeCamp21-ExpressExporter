...
Rs0 f0 inParameterDecl '<workflow.humantask.ProcurementRequest procurementRequestData> param;' #txt
...
>Proto Rs0 .type workflow.humantask.RequestDetails.RequestDetailsData #txt
