package workflow.agileBPM.define_WF;

/**
 */
@SuppressWarnings("all")
@javax.annotation.processing.Generated(comments="This is the java file of the ivy data class define_WFData", value={"ch.ivyteam.ivy.scripting.streamInOut.IvyScriptJavaClassBuilder"})
public class define_WFData extends ch.ivyteam.ivy.scripting.objects.CompositeObject
{
  /** SerialVersionUID */
  private static final long serialVersionUID = 2758999613355236157L;

  private transient ch.ivyteam.ivy.scripting.objects.List<workflow.agileBPM.TaskDef> definedTasks;
  ...
  private workflow.agileBPM.TaskDef newTask;

  /**
   * Gets the field newTask.
   * @return the value of the field newTask; may be null.
   */
  public workflow.agileBPM.TaskDef getNewTask()
  {
    return newTask;
  }
   ...
   */
  public void setNewTask(workflow.agileBPM.TaskDef _newTask)
  {
    newTask = _newTask;
  }
  ...
  private workflow.agileBPM.TaskDef editTask;

  /**
   * Gets the field editTask.
   * @return the value of the field editTask; may be null.
   */
  public workflow.agileBPM.TaskDef getEditTask()
  {
    return editTask;
  }
   ...
   */
  public void setEditTask(workflow.agileBPM.TaskDef _editTask)
  {
    editTask = _editTask;
  }
