package workflow.agileBPM.task_Form;

/**
 */
@SuppressWarnings("all")
@javax.annotation.processing.Generated(comments="This is the java file of the ivy data class task_FormData", value={"ch.ivyteam.ivy.scripting.streamInOut.IvyScriptJavaClassBuilder"})
public class task_FormData extends ch.ivyteam.ivy.scripting.objects.CompositeObject
{
  /** SerialVersionUID */
  private static final long serialVersionUID = -1867158705362755999L;

  private transient workflow.agileBPM.CaseDef caseInfo;
  ...
  private transient workflow.agileBPM.TaskDef nextTask;
  ...
  private ch.ivyteam.ivy.scripting.objects.List<workflow.agileBPM.TaskDef> taskHistory;

  /**
   * Gets the field taskHistory.
   * @return the value of the field taskHistory; may be null.
   */
  public ch.ivyteam.ivy.scripting.objects.List<workflow.agileBPM.TaskDef> getTaskHistory()
  {
    return taskHistory;
  }
   ...
   */
  public void setTaskHistory(ch.ivyteam.ivy.scripting.objects.List<workflow.agileBPM.TaskDef> _taskHistory)
  {
  ...
  private workflow.agileBPM.TaskDef addTask;

  /**
   * Gets the field addTask.
   * @return the value of the field addTask; may be null.
   */
  public workflow.agileBPM.TaskDef getAddTask()
  {
    return addTask;
  }
   ...
   */
  public void setAddTask(workflow.agileBPM.TaskDef _addTask)
  {
    addTask = _addTask;
  }
