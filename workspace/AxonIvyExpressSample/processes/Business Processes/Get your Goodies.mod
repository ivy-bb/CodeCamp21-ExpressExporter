...
Gs0 f1 dialogId axon.ivy.express.sample.ProcessDlg #txt
...
Gs0 f5 dialogId axon.ivy.express.sample.ProcessDlg #txt
...
' #txt
Gs0 f5 responseMappingAction 'out=result.data;
' #txt
...
Gs0 f9 dialogId axon.ivy.express.sample.ProcessDlg #txt
...
Gs0 f12 dialogId axon.ivy.express.sample.ProcessDlg #txt
Gs0 f12 startMethod start(axon.ivy.express.sample.Get_your_Goodies_Data) #txt
Gs0 f12 requestActionDecl '<axon.ivy.express.sample.Get_your_Goodies_Data data> param;' #txt
Gs0 f12 requestMappingAction 'param.data.check_goods_on_stock=in.check_goods_on_stock;
