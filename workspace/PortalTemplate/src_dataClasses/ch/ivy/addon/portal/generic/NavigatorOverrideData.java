...
@javax.annotation.processing.Generated(comments="This is the java file of the ivy data class NavigatorOverrideData", value={"ch.ivyteam.ivy.scripting.streamInOut.IvyScriptJavaClassBuilder"})
public class NavigatorOverrideData extends ch.ivyteam.ivy.scripting.objects.CompositeObject
{
  /** SerialVersionUID */
  private static final long serialVersionUID = 5935755581777585039L;
  ...
  private transient ch.ivyteam.ivy.workflow.ICase iCase;
  ...
  private transient ch.ivyteam.ivy.workflow.ITask iTask;
