...
Cs0 Check_goods_on_stockProcess Big #zClass
Cs0 RD #cInfo
Cs0 #process
...
>Proto Cs0 Cs0 Check_goods_on_stockProcess #zField
...
Cs0 f0 inParameterMapAction 'out.check_goods_on_stock=param.data.check_goods_on_stock;
...
Cs0 f0 outParameterMapAction 'result.data.check_goods_on_stock=in.check_goods_on_stock;
' #txt
...
>Proto Cs0 .type axon.ivy.express.sample.Check_goods_on_stock.Check_goods_on_stockData #txt
